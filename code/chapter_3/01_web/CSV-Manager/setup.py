...
setup(
    ...
    setup_requires=[],
    tests_require=[],
    install_requires=['groundwork', 'groundwork-database', 'groundwork-web', 'pytest-runner', 'sphinx', 'gitpython'],
    classifiers=[
    ...
    entry_points={
        ...
        'groundwork.plugin': ["csv_manager_plugin = "
                              ...
                              "csv_watcher_db_plugin = "
                              "csv_manager.plugins.csv_watcher_db_plugin.csv_watcher_db_plugin:CsvWatcherDbPlugin"
                              ],
    }
